...
public class TestGetWarningMessage {
    ...
    @Test
    /*the drinks have two dangerous ingredients*/
    public void moreDangerousIngredients() {
        Date date1 = new Date();
        Drink drink1 = new Drink("1", 1.0f, "I am description", "egg", 10, date1, date1, 1);
        Drink drink2 = new Drink("2", 2.0f, "I am description", "chicken", 1, date1, date1, 1);
        ...
        assertEquals(T, "Drinks in shopping cart contains wheat, egg ");
    }
